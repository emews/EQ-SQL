...
# DB CLEAN QUEUES SH
# Deletes the EMEWS queues IN and OUT!
...
then
  echo
  echo "Deleting all rows from EMEWS queue tables ... Enter to confirm ... Ctrl-C to cancel ..."
  read _
  echo "Deleting all rows from EMEWS queue tables ..."
  echo
